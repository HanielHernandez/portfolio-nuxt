...
<template>
    <div
        class="flex flex-col justify-centeritems-center px-4 lg:px-0 lg:max-w-2xl w-full mx-auto"
        ...
        >
            ...
            <div class="flex flex-col-reverse md:flex-row items-center md:items-start md:justify-between w-full">
                <div class="md:pr-8 h-full">
                    ...
                    <p
                        class="text-neutral-600 text-justify text-clip mb-4"
                        v-html="$t(`myWork.professionalExperience.${experience.id}.description`)"
                    ></p>
                    <chip
                ...
                <div class="flex-shrink-0 dark:bg-neutral-700 bg-neutral-300 rounded-md p-4 w-32 h-32 mb-4 md:mb-0">
                    <img
                        :src="`/img/works-places/${experience.companyLogo}`"
                        class="flex-0 rounded-md mx-auto my-0 w-24 h-24 object-contain"
                        alt=""
                    />
                </div>
            </div>
