                ...
                <div class="flex w-full md:flex-row justify-between items-center">
                    ...
                    <div class="items-center flex z-50">
                        ...
                        <div class="hidden items-center lg:flex">
                            <span class="mx-1 md:mx-2 lg:mx-3 dark:text-white/20 text-neutral-300">|</span>
                            <AtButton
                                element="a"
                                link
                                href="mailto:haniel1121@outlook.com "
                                class="hover:drop-shadow-lg hover:shadow-md transition-shadow ease-in-out duration-500"
                            >
                                {{ $t('navbar.contactMe') }}
                            </AtButton>
                        </div>
