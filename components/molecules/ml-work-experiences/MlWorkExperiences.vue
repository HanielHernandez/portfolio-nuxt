...
<template>
  <div class="flex flex-col">
    <h3 id="projects_title"
      class="text-2xl text-neutral-600 dark:text-neutral-200  text-center m-0 mb-6  font-bold px-4  md:px-0">
      {{ props.title }}
    </h3>
    <div id="my_profesional_experience" class="flex flex-col items-center max-w-2xl w-full mx-auto my-0">
