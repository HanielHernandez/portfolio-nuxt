...
<template>
    <footer
        class="border-t border-neutral-100 bg-neutral-100 dark:border-neutral-700 bg-nuetral-300 dark:bg-neutral-900 mt-20"
    >
        <div
            class="mx-auto px-4 md:px-8 py-12"
            style="max-width: 1024px"
        >
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                <!-- About Section -->
                <div>
                    <h5 class="font-semibold text-neutral-900 dark:text-white mb-4">About</h5>
                ...
                <!-- Quick Links -->
                <div>
                    <h5 class="font-semibold text-neutral-900 dark:text-white mb-4">Quick Links</h5>
                    <ul class="space-y-2">
                        <li>
                            <NuxtLink
                                to="/"
                ...
                <!-- Social Links -->
                <div>
                    <h5 class="font-semibold text-neutral-900 dark:text-white mb-4">Connect</h5>
