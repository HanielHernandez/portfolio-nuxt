...
<template>
  ...
  >
    ...
    >
      <h2
        class="text-xl font-bold lg:text-4xl text-blue-600 mb-8 lg:mb-12 dark:text-blue-300"
      >
        {{ $t('home.firstLine') }}
      </h2>
      <h1
    ...
    <div
      class="flex justify-center items-center w-full lg:w-1/2 lg:h-full px-4"
    >
